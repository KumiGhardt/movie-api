...
let topMovies = [{
        ...
        director: ['Victor Fleming', 'Born: February 23, 1889 in La Cañada, California, USA', 'Died: January 6, 1949 (age 59) in Cottonwood, Arizona, USA'],
        year: 1939,
        rating: 8.1,
        genre: ['Drama', 'History', 'Romance', 'War'],
        bio: 'A manipulative woman and a roguish man conduct a turbulent romance during the American Civil War and Reconstruction periods.'
    },
    {
        title: 'The Sound of Music',
        stars: ['Julie Andrews', 'Christopher Plummer'],
        director: ['Robert Wise', 'Born: September 10, 1914 in Winchester, Indiana, USA', 'Died: September 14, 2005 (age 91) in Los Angeles, California, USA'],
        year: 1965,
        rating: 8.0,
        genre: ['Romance', 'Musical', 'Family', 'Drama', 'Biography'],
        bio: 'A woman leaves an Austrian convent to become a governess to the children of a Naval officer widower.'
    },
    {
        title: 'Black Panther',
        stars: ['Chadwick Boseman', 'Michael B. Jordan'],
        director: ['Ryan Coogler', 'Born: August 25, 1972 in London, England, UK'],
        year: 2018,
        rating: 7.3,
        genre: ['Action', 'Adventure', 'SciFi'],
        bio: 'Prince T\'Challa returns home to the reclusive, technologically advanced African nation of Wakanda to serve as his country\'s new king. However, T\'Challa soon finds that he is challenged for the throne from factions within his own country. When two foes conspire to destroy Wakanda, the hero known as Black Panther must team up with C.I.A. agent Everett K. Ross and members of the Dora Milaje, Wakandan special forces, to prevent Wakanda from being dragged into a world war. '
    },
    {
    ...
    },
    {
        ...
        director: ['Peter Jackson', 'Born: October 31, 1961 in Pukerua Bay, North Island, New Zealand'],
        year: 2001,
        rating: 8.8,
...

    {
        ...
        director: ['Blake Edwards', 'Born: July 26, 1922 in Tulsa, Oklahoma, USA', 'Died: December 15, 2010 (age 88) in Santa Monica, California, USA'],
        year: 1961,
        rating: 7.6,
        genre: ['Comedy', 'Drama', 'Romance'],
        bio: 'A young New York socialite becomes interested in a young man who has moved into her apartment building, but her past threatens to get in the way.'
    },
...

    {
        ...
        director: ['Oliver Hirschbiegel', 'Born: December 29, 1957 in Hamburg, Germany'],
        year: 2003,
        rating: 8.2,
        genre: [' Biography', 'Drama', ' History', ' War'],
        bio: 'In April of 1945, Germany stands at the brink of defeat with the Soviet Armies closing in from the west and south. In Berlin, capital of the Third Reich, Adolf Hitler proclaims that Germany will still achieve victory and orders his Generals and advisers to fight to the last man.'
    },

    {
        title: 'Im Keller',
        stars: ['Friz Lang', 'Manfred Ellinger', 'Alfreda Klebinger'],
        director: ['Ulrich Seidl', 'Born: November 24, 1952 in Vienna, Austria'],
        year: 2014,
        rating: 6.7,
        genre: 'Documentary',
        bio: 'A documentary that reveals what its subjects do in their respective basements.'
    }
